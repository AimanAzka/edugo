...
<?php
include "koneksi.php";
 $sql=mysql_query("select * from tutor order by id_tutor DESC LIMIT 0,1");
 $data=mysql_fetch_array($sql);
 $kodeawal=substr($data['id_tutor'],3,4)+1;
 if($kodeawal<10){
  $kode='T0000'.$kodeawal;
...
<div class="wrap row">
    ...
    <div class="large-12 coloumn text-center">
                <h2 class="section-heading"><strong>Registrasi Tutor</strong></h2>
            </div>
    
<div class="formregistrasi">
<form action="proses_daftar_tutor.php" method="post" enctype="multipart/form-data">
<p>

	<table>
		<tr><td>Id Tutor</td>  <td>:</td> <td><input type="text" name="tkode" id="tkode" value="<?php echo $kode;?>" readonly="true" /></td></tr>
		<tr><td>Nama Lengkap</td>  <td>:</td> <td><input type="text" name="nama_lengkap_tutor" size="25" maxlength="25" value="" required /></td></tr>
		...
		<tr><td>Provinsi</td>      <td>:</td> <td><select name="provinsi" required />
                        <option value="sumbar">Jakarta</option>
		...
		<tr><td>lulusan</td>     <td>:</td> <td><select name="lulusan" required />
						<option value="S1">S1</option>
						<option value="S2">S2</option>
						<option value="S3">S3</option>
						<option value="S4">Profesor</option>
					</select></td></tr>
		...
		<tr><td>Upload Berkas</td>  <td>:</td> <td> <input type="file" name="file" required />Max size : 500 kb</td></tr>
		<tr><td>Upload Foto</td>  <td>:</td> <td> <input type="file" name="foto" required />Max size : 500 kb</td></tr>
    <tr><td>Pilih Keahlian</td>      <td>:</td> <td><select name="keahlian" required />
		...
		<td colspan="3"><input type="submit" name="submit" value="Daftar" class="button expanded"></td>
	    </tr>
	</table>
